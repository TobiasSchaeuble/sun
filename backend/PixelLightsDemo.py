...
try: 
   ...
   LEDs.rainbowCycle(ledpixels, 0.00) # rainbow swirl

   LEDs.cls(ledpixels) # clears all the pixels to black
   time.sleep(0.5)

   LEDs.setpixelcolor(ledpixels, 10, LEDs.Color(0,255,0)) # from ledpixels, sets pixel 10 (starting from 0) to green
